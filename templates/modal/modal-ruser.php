...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ruserModal">
                        Registrasi User
                    </button>

<!-- Logout Modal-->
<div class="modal fade" id="ruserModal" tabindex="-1" role="dialog" aria-labelledby="modalRuser" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="user-select-none modal-header bg-primary text-white">
                <h5 class="modal-title" id="ruserModalLabel">Menu Registrasi User?</h5>
