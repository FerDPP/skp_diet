...
$faq = [
    [
        'title' => 'Bagaimana cara menggunakan sistem pendukung keputusan ini?',
        'content' => 'Anda dapat menggunakan sistem pendukung keputusan ini dengan mengakses halaman website kami dan mengisi form yang tersedia dengan data personal seperti preferensi diet, intensitas olahraga, dan pola makan. Sistem akan memberikan rekomendasi jenis diet terbaik yang sesuai dengan kebutuhan Anda.'
    ],
    [
        'title' => 'Apakah sistem ini hanya untuk penurunan berat badan?',
        'content' => 'Ya, sistem ini dirancang khusus untuk membantu memilih jenis diet terbaik untuk tujuan penurunan berat badan.'
    ],
    [
    ...
    [
        'title' => 'Apakah sistem ini terintegrasi dengan aplikasi kesehatan lain?',
        'content' => 'Tidak, saat ini sistem ini belum terintegrasi dengan aplikasi kesehatan lain. Namun, kami terus mengembangkan sistem agar lebih terintegrasi dan bermanfaat bagi pengguna.'
    ]
];
